    ...
    <>
      ...
      <Drawer anchor="left" open={open} onClose={() => setOpen(false)}>
        <List sx={{ width: 250 }}>
          ...
          <ListItem button component={Link} href="/stores" onClick={() => setOpen(false)}>
            <ListItemIcon><StoreIcon /></ListItemIcon>
            <ListItemText primary="Stores" />
          </ListItem>
          <ListItem button component={Link} href="/skus" onClick={() => setOpen(false)}>
            <ListItemIcon><ShoppingCartIcon /></ListItemIcon>
            <ListItemText primary="SKU" />
          </ListItem>
          <ListItem button component={Link} href="/planning" onClick={() => setOpen(false)}>
            <ListItemIcon><CalendarTodayIcon /></ListItemIcon>
            <ListItemText primary="Planning" />
          </ListItem>
          <ListItem button component={Link} href="/charts" onClick={() => setOpen(false)}>
